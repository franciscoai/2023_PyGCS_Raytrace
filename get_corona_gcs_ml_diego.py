...
def get_corona(sat, imsize=None, diff=True, rnd_rot=False):
    ...
    cor2_path= "/media/gehme/gehme/projects/2020_gcs_with_ml/data/corona_background_affects/cor2"#/gehme/projects/2020_gcs_with_ml/data/corona_background_kincat/cor2"
    lasco_path="/media/gehme/gehme/projects/2020_gcs_with_ml/data/corona_background_affects/lasco"
